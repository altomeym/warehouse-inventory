...
const AsideTopSubMenuItem = (props) => {
    ...
    return (
        <nav
            className='navbar navbar-expand-xl navbar-light top-navbar d-xl-flex align-items-stretch d-block px-3 px-xl-0 py-4 py-xl-0'>
                        ...
                        asideConfig && asideConfig.map((mainItems, index) => {
                            return (
                                <div key={index}
                                     ...
                                     || location.pathname === (mainItems.supplierReportDetailsPath + '/' + id.id) ? 'd-flex' : 'd-none'}`}>
