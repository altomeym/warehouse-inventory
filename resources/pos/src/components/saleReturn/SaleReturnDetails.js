...
const SaleReturnDetails = (props) => {
    ...
    const shippingData = saleReturnDetails?.shipping_data ? JSON.parse(saleReturnDetails?.shipping_data) : [];
                            ...
                            <Col md={4}>
                                ...
                                <div className='p-4'>
                                    ...
                                    <div className='pb-1'>
                                        ...
                                        {saleReturnDetails && saleReturnDetails.sale?.attributes?.toStatus?.name ? 
                                          <span className='badge bg-light-primary'>
                                             <span> {saleReturnDetails.sale?.attributes?.toStatus?.name} </span>
                                           </span> 
                                         : '' }
                                    </div>
                                    <div className='pb-1'>
