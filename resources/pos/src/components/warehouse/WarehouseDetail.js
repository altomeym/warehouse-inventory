...
const WarehouseDetail = () => {
    ...
    return (
        <MasterLayout>
            ...
            <HeaderTitle
                title={getFormattedMessage("warehouse.details.title")}
                to="/app/warehouse"
            />
                        ...
                        <tbody>
                            {warehouseDetails.length >= 1
                                ...
                                warehouseDetails.map((item, index) => {
                                      const img =
                                          item.product_image &&
                                          item.product_image.imageUrls &&
                                          item.product_image.imageUrls[0];
                                        //   grandTotal = grandTotal + item.quantity;
                                      return (
                                          <tr key={index}>
                                              <td>
                            ...
                            <tr>
                                ...
                                <td >
                                    <div className="badge bg-light-primary me-2">
                                        <h4>{(warehouseDetails.reduce((a,v) =>  a = a + v.quantity , 0 ))}</h4>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
